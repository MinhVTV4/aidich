...
import { Languages, ScanSearch, Menu, X, Sparkles, MessageSquareText, Film, Users, History as HistoryIcon, LogOut } from 'lucide-react';
...
export default function Sidebar({ currentApp, setCurrentApp, isOpen, setIsOpen }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'history', icon: HistoryIcon, label: 'Lịch sử của tôi' },
  ];
